...
import com.example.dashan.agrofarm.utilities.OpenWeatherJsonUtils;

import java.net.URL;

public class WeatherActivity extends AppCompatActivity implements ForecastAdapter.ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]>,SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        LoaderManager.LoaderCallbacks<String[]> callback = WeatherActivity.this;
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                String locationQuery = SunshinePreferences
                        .getPreferredWeatherLocation(WeatherActivity.this);
                ...
                try {
                    ...
                    String[] simpleJsonWeatherData = OpenWeatherJsonUtils
                            .getSimpleWeatherStringsFromJson(WeatherActivity.this, jsonWeatherResponse);
